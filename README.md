...
3. Перейдите в каталог скачанного репозитория. Для этого выполните команду cd green-app

4. Установите зависимости проекта. Для этого выполните команду npm install

5. Запустите локальный сервер. Для этого выполните команду npm start

6. Откройте веб-браузер и перейдите по адресу http://localhost:3000, чтобы просмотреть ваш проект в локальном окружении.
